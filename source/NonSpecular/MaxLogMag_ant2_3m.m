...
for i=12:17
    ...
    p(i-11)=plot(freqPoints/1e9,results.algoSEmax{256}.logmagDataPoints);
end
datatip(p(1),'DataIndex',76); % Datatip at 5.375GHz dist 1m
legend('1m','1,5m','2m','3m','5m','7m')
title('Max SE; Ant1 1-7m 0°; Ant2 3m 45°')
...
for i=12:17
    load(fullfile(folderPath,sprintf("%02i.mat",i)))
    p(i-11)=plot(freqPoints/1e9,results.algoGreedyMax{100}.logmagDataPoints);
end
datatip(p(1),'DataIndex',76); % Datatip at 5.375GHz dist 1m
legend('1m','1,5m','2m','3m','5m','7m')
title('Max Greedy; Ant1 1-7m 0°; Ant2 3m 45°')
xlabel('Frequency [GHz]')
ylabel('S21 [dB]')
ylim([-50 10])
grid on
...
datatip(p(1),'DataIndex',76); % Datatip at 5.375GHz dist 1m
legend('1m','1,5m','2m','3m','5m','7m')
title('Max Geometric; Ant1 1-7m 0°; Ant2 3m 45°')
xlabel('Frequency [GHz]')
ylabel('S21 [dB]')
ylim([-50 10])
grid on
...
for i=12:17
    load(fullfile(folderPath,sprintf("%02i.mat",i)))   
    p(i-11)=plot(freqPoints/1e9,reference.RISallOn.logmagDataPoints); 
end
datatip(p(1),'DataIndex',76); % Datatip at 5.375GHz dist 1m
legend('1m','1,5m','2m','3m','5m','7m')
title('RIS all elements on; Ant1 1-7m 0°; Ant2 3m 45°')
xlabel('Frequency [GHz]')
ylabel('S21 [dB]')
ylim([-50 10])
grid on
