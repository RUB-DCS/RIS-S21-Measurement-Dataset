...
load(fullfile(folderPath,"24.mat"))   
...
title('Reference Ant1 1m 45°; Ant2 3m 45°')
...
load(fullfile(folderPath,"25.mat"))   
plot(freqPoints/1e9,reference.RISallOn.logmagDataPoints); 
plot(freqPoints/1e9,reference.RISallOff.logmagDataPoints); 
plot(freqPoints/1e9,reference.Plate.logmagDataPoints); 
plot(freqPoints/1e9,reference.noPlate.logmagDataPoints); 
...
legend('All On', 'All Off', 'Reference Plate', 'Empty')
title('Reference Ant1 2m 45°; Ant2 3m 45°')
xlabel('Frequency [GHz]')
ylabel('S21 [dB]')
ylim([-60 0])
grid on
...
%% Plot Reference S21
%  Ant1 distance 23, Ant2 distance 3m
subplot 313
hold on

load(fullfile(folderPath,"26.mat"))   
plot(freqPoints/1e9,reference.RISallOn.logmagDataPoints); 
plot(freqPoints/1e9,reference.RISallOff.logmagDataPoints); 
plot(freqPoints/1e9,reference.Plate.logmagDataPoints); 
plot(freqPoints/1e9,reference.noPlate.logmagDataPoints); 
...
legend('All On', 'All Off', 'Reference Plate', 'Empty')
title('Reference Ant1 3m 45°; Ant2 3m 45°')
xlabel('Frequency [GHz]')
ylabel('S21 [dB]')
ylim([-80 0])
grid on
